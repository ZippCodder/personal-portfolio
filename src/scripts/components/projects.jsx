  ...
  <main className="projects"> 
   ...
   <img src="/public/images/paperclip.png" className="paperclip" />
    <div className="content__projects">
     <Project title="Centro" logo="/public/images/main-centro-logo.png" description="A job application service and platform which aids job-seekers in finding jobs which aligns with their skills and requirements, and generating referrals for their applicant profile." code="https://github.com/ZippCodder/Avenida" project="https://crcentro.com/" previews={["/public/images/centro-pic-3.png","/public/images/centro-pic-2.png","/public/images/centro-pic-1.png"]} subtitle="Writers Platform" tech={["HTML, CSS, Javascript", "React", "Node.JS","MongoDB"]}/> 
